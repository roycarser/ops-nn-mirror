...
/*!
 * \file aclnn_lstm_backward.h
 * \brief
 */

#ifndef OP_API_INC_LEVEL2_ACLNN_LSTM_BACKWARD_H_
#define OP_API_INC_LEVEL2_ACLNN_LSTM_BACKWARD_H_
...
#endif // OP_API_INC_LEVEL2_ACLNN_LSTM_BACKWARD_H_
