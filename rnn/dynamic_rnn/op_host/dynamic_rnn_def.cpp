...
{
    std::string
        resJsonStr = "{\"input0\":{\"name\":\"x\", \"dtype\":\"float32,float16\", \"format\":\"ND,ND\", "
                     "\"unknownshape_format\":\"ND,ND\"},"
                     "\"input1\":{\"name\":\"w\", \"dtype\":\"float32,float16\", \"format\":\"ND,ND\", "
                     "\"unknownshape_format\":\"ND,ND\"},"
                     "\"input2\":{\"name\":\"b\", \"dtype\":\"float32,float16\", \"format\":\"ND,ND\", "
                     "\"unknownshape_format\":\"ND,ND\"},"
                     "\"input3\":{\"name\":\"seq_length\", \"dtype\":\"float32,float16\", \"format\":\"ND,ND\", "
                     "\"unknownshape_format\":\"ND,ND\"},"
                     "\"input4\":{\"name\":\"init_h\", \"dtype\":\"float32,float16\", \"format\":\"ND,ND\", "
                     "\"unknownshape_format\":\"ND,ND\"},"
                     "\"input5\":{\"name\":\"init_c\", \"dtype\":\"float32,float16\", \"format\":\"ND,ND\", "
                     "\"unknownshape_format\":\"ND,ND\"},"
                     "\"input6\":{\"name\":\"wci\", \"dtype\":\"float32,float16\", \"format\":\"ND,ND\", "
                     "\"unknownshape_format\":\"ND,ND\"},"
                     "\"input7\":{\"name\":\"wcf\", \"dtype\":\"float32,float16\", \"format\":\"ND,ND\", "
                     "\"unknownshape_format\":\"ND,ND\"},"
                     "\"input8\":{\"name\":\"wco\", \"dtype\":\"float32,float16\", \"format\":\"ND,ND\", "
                     "\"unknownshape_format\":\"ND,ND\"},"
                     "\"input9\":{\"name\":\"mask\", \"dtype\":\"uint8,uint8\", \"format\":\"ND,ND\", "
                     "\"unknownshape_format\":\"ND,ND\"},"
...
public:
    explicit DynamicRNN(const char* name) : OpDef(name)
    {
        ...
        this->Attr("gate_order").AttrType(REQUIRED).String("ifjo");
