...
template <typename T1, typename T2>
__aicore__ inline void CrossEntropyLossGradWeightNone<T1, T2>::Init(
...
template <typename T1, typename T2>
__aicore__ inline void CrossEntropyLossGradWeightNone<T1, T2>::SmoothLabel(uint64_t nLoopIdx, uint64_t calcLen,
