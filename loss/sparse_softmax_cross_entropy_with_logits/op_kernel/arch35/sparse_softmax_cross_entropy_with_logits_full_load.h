...
__simt_vf__ __aicore__ LAUNCH_BOUND(1024) inline void UbSimtComputeLoopRFullLoad(
    __ubuf__ float* temp1Addr, __ubuf__ float* temp2Addr, __ubuf__ T2* labelsAddr, __ubuf__ float* gatherAddr,
...
private:
    __aicore__ inline void VfSubExp(int64_t tileNum, int64_t r, int64_t rAlign, LocalTensor<float>& maxBuf,
                                    LocalTensor<T1>& featuresBuf, LocalTensor<float>& subBuf,
                                    LocalTensor<float>& temp1Buf);
    __aicore__ inline void VfBackProp(int64_t tileNum, int64_t r, int64_t rAlign, LocalTensor<float>& sumBuf,
                                      LocalTensor<float>& temp1Buf, LocalTensor<float>& logBuf,
                                      LocalTensor<T2>& labelsBuf, LocalTensor<T1>& backPropBuf,
    ...
    __aicore__ inline void CopyInPadFeatures(TQue<QuePosition::VECIN, 1>& dstQueue, GlobalTensor<T1>& srcTensor,
                                             int64_t tileNum, int64_t offset);
    __aicore__ inline void CopyInPadLabels(TQue<QuePosition::VECIN, 1>& dstQueue, GlobalTensor<T2>& srcTensor,
                                           int64_t tileNum, int64_t offset);
    __aicore__ inline void CopyOutPadBackProp(GlobalTensor<T1>& dstTensor, TQue<QuePosition::VECOUT, 1>& srcQueue,
                                              int64_t tileNum, int64_t offset, int64_t rNum);
    __aicore__ inline void CopyOutPadLoss(GlobalTensor<T1>& dstTensor, TQue<QuePosition::VECOUT, 1>& srcQueue,
                                          int64_t nTailNum, int64_t offset);
    __aicore__ inline void Compute(int64_t tileNum, int64_t aOffset);
    __aicore__ inline void VfReduceMax(int64_t tileNum, int64_t r, int64_t rAlign, LocalTensor<float>& maxBuf,
                                       LocalTensor<T1>& featuresBuf);
...
template <typename T1, typename T2, uint64_t schId, uint64_t db>
__aicore__ inline void SparseSoftmaxCrossEntropyWithLogitsFullLoad<T1, T2, schId, db>::Init(
...
template <typename T1, typename T2, uint64_t schId, uint64_t db>
__aicore__ inline void SparseSoftmaxCrossEntropyWithLogitsFullLoad<T1, T2, schId, db>::ProcessEachCore(
    int64_t tileNum, int64_t tailNum, int64_t loopTimes)
{
...
template <typename T1, typename T2, uint64_t schId, uint64_t db>
__aicore__ inline void SparseSoftmaxCrossEntropyWithLogitsFullLoad<T1, T2, schId, db>::Compute(int64_t tileNum,
                                                                                               int64_t aOffset)
{
    ...
    asc_vf_call<UbSimtComputeLoopRFullLoad<T1, T2, schId, db>>(
        dim3{1024}, (__ubuf__ float*)temp1Buf.GetPhyAddr(), (__ubuf__ float*)temp2Buf.GetPhyAddr(),
        (__ubuf__ T2*)labelsBuf.GetPhyAddr(), (__ubuf__ float*)maxBuf.GetPhyAddr(), tileNum, simtParam1, simtParam2);
...
template <typename T1, typename T2, uint64_t schId, uint64_t db>
__aicore__ inline void SparseSoftmaxCrossEntropyWithLogitsFullLoad<T1, T2, schId, db>::CopyInPadFeatures(
    TQue<QuePosition::VECIN, 1>& dstQueue, GlobalTensor<T1>& srcTensor, int64_t tileNum, int64_t offset)
{
...
template <typename T1, typename T2, uint64_t schId, uint64_t db>
__aicore__ inline void SparseSoftmaxCrossEntropyWithLogitsFullLoad<T1, T2, schId, db>::CopyInPadLabels(
    TQue<QuePosition::VECIN, 1>& dstQueue, GlobalTensor<T2>& srcTensor, int64_t tileNum, int64_t offset)
{
...
template <typename T1, typename T2, uint64_t schId, uint64_t db>
__aicore__ inline void SparseSoftmaxCrossEntropyWithLogitsFullLoad<T1, T2, schId, db>::CopyOutPadBackProp(
    GlobalTensor<T1>& dstTensor, TQue<QuePosition::VECOUT, 1>& srcQueue, int64_t tileNum, int64_t offset, int64_t rNum)
{
...
template <typename T1, typename T2, uint64_t schId, uint64_t db>
__aicore__ inline void SparseSoftmaxCrossEntropyWithLogitsFullLoad<T1, T2, schId, db>::CopyOutPadLoss(
    GlobalTensor<T1>& dstTensor, TQue<QuePosition::VECOUT, 1>& srcQueue, int64_t nTailNum, int64_t offset)
{
    LocalTensor<T1> srcBuf = srcQueue.DeQue<T1>();
    DataCopyExtParams copyParams;
    copyParams.blockCount = 1;
...
template <typename T1, typename T2, uint64_t schId, uint64_t db>
__aicore__ inline void SparseSoftmaxCrossEntropyWithLogitsFullLoad<T1, T2, schId, db>::VfReduceMax(
    int64_t tileNum, int64_t r, int64_t rAlign, LocalTensor<float>& maxBuf, LocalTensor<T1>& featuresBuf)
{
    ...
    __VEC_SCOPE__
    {
        ...
        for (uint16_t i = 0; i < aTimes; i++) {
            ...
            AscendC::MicroAPI::Move<T1, AscendC::MicroAPI::MaskMergeMode::MERGING>(featuresReg, featuresReg1, preg);
...
template <typename T1, typename T2, uint64_t schId, uint64_t db>
__aicore__ inline void SparseSoftmaxCrossEntropyWithLogitsFullLoad<T1, T2, schId, db>::VfSubExp(
    int64_t tileNum, int64_t r, int64_t rAlign, LocalTensor<float>& maxBuf, LocalTensor<T1>& featuresBuf,
    LocalTensor<float>& subBuf, LocalTensor<float>& temp1Buf)
{
...
template <typename T1, typename T2, uint64_t schId, uint64_t db>
__aicore__ inline void SparseSoftmaxCrossEntropyWithLogitsFullLoad<T1, T2, schId, db>::VfBackProp(
    int64_t tileNum, int64_t r, int64_t rAlign, LocalTensor<float>& sumBuf, LocalTensor<float>& temp1Buf,
    LocalTensor<float>& logBuf, LocalTensor<T2>& labelsBuf, LocalTensor<T1>& backPropBuf, LocalTensor<float>& temp2Buf,
    LocalTensor<float>& subBuf)
{
    ...
    __VEC_SCOPE__
    {
        ...
        for (uint16_t i = 0; i < aTimes; i++) {
            ...
            for (uint16_t k = 0; k < tailLoop; k++) {
                ...
                AscendC::MicroAPI::StoreAlign(temp1Addr + i * rAlign + repeatTimes * vfLen, temp1Reg, preg);
                AscendC::MicroAPI::Log(logReg, sumReg, preg);
                AscendC::MicroAPI::Sub(temp2Reg, logReg, subReg, preg);
                AscendC::MicroAPI::StoreAlign(temp2Addr + i * rAlign + repeatTimes * vfLen, temp2Reg, preg);
            }
        }
    }
}
