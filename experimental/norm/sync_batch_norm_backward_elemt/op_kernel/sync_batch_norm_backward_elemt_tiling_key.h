...
/*!
 * \file sync_batch_norm_backward_elemt_tiling_key.h
 * \brief
 */

#ifndef __SYNC_BATCH_NORM_BACKWARD_ELEMT_TILING_KEY_H__
#define __SYNC_BATCH_NORM_BACKWARD_ELEMT_TILING_KEY_H__
...
ASCENDC_TPL_ARGS_DECL(SyncBatchNormBackwardElemt,
