...
template <typename T>
__aicore__ void SubListNormalAdapter(const LocalTensor<T>& dstLocal, const LocalTensor<T>& srcLocal1,
...
template <typename T>
__aicore__ void SubListFloatAdapter(const LocalTensor<T>& dstLocal, const LocalTensor<T>& srcLocal1,
                                    const LocalTensor<T>& srcLocal2, const T& scalarVal, const int32_t& uValue)
{
...
extern "C" __global__ __aicore__ void foreach_sub_list(GM_ADDR inputs_1, GM_ADDR inputs_2, GM_ADDR alpha,
