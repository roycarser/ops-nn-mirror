...
private:
                                   ...
                                   bool isRemainder)
    {
        ...
        if (isRemainder) {
            ...
            DataCopyPad(Base::outTensorsGM[1ULL * index * Base::maxDataCount], inLocal1, copyParams);
        } else {
            DataCopy(Base::outTensorsGM[1ULL * index * Base::maxDataCount], inLocal1, dataCount);
        }
