...
private:
                                   ...
                                   bool isRemainder)
    {
        ...
        if (isRemainder) {
            ...
            DataCopyPad(Base::outTensorsGM[1ULL * index * Base::maxDataCount], inLocal_1, copyParams);
        } else {
            DataCopy(Base::outTensorsGM[1ULL * index * Base::maxDataCount], inLocal_1, dataCount);
        }
    ...
    __aicore__ inline void CopyInPlus(uint32_t index, int64_t dataCount, bool isRemainder)
    {
        ...
        if (isRemainder) {
            ...
            DataCopyPad(inLocal_2, inTensorsGM_2[1ULL * index * Base::maxDataCount], copyParams, padParams);
            DataCopyPad(inLocal_3, inTensorsGM_3[1ULL * index * Base::maxDataCount], copyParams, padParams);
        } else {
            DataCopy(inLocal_2, inTensorsGM_2[1ULL * index * Base::maxDataCount], dataCount);
            DataCopy(inLocal_3, inTensorsGM_3[1ULL * index * Base::maxDataCount], dataCount);
        }
