 ...
 */
__attribute__((deprecated("aclnnQuantMatmulV4GetWorkspaceSize is scheduled to be deprecated in a post-December 2026 version update, "
 ...
 * @return aclnnStatus: 返回状态码
 */
__attribute__((deprecated("aclnnQuantMatmulV4 is scheduled to be deprecated in a post-December 2026 version update, "
