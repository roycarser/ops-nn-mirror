                                 ...
                                 const bool transposeX1, const bool transposeX2, const int64_t opImplModeEnum)
{
    ...
    return CheckAscendCScenario(x1, x2, bias, mmOpInfo, transposeX1, transposeX2) ||
           CheckAscendCScenario2(x1, x2, mmOpInfo, transposeX1, transposeX2) || enableForceGrpAccForFp32 || isFP32Wnz;
}
...
static bool CheckStreamKSKTiling(MmOpInfo& mmOpInfo)
{
    ...
    uint64_t kThreshold = std::max(STREAM_K_MIN_K_THRESHOLD, aiCoreCnt * BASIC_BLOCK_K_256_BYTE) / dtypeASize;
...
static aclnnStatus SetMatmulOpSupportFormat(const aclTensor* self, const aclTensor* mat2, MmOpInfo& mmOpInfo)
{
    // 判断当前Shape是否支持使用ND输入输出
    SetMmSupportFormat(self, mat2, mmOpInfo);
...
bool IsSupportNzNzNd(const aclTensor* self, const aclTensor* mat2)
{
    op::Shape selfShape = self->GetViewShape();
    op::Shape mat2Shape = mat2->GetViewShape();
    uint64_t dimNum = static_cast<uint64_t>(selfShape.GetDimNum());
    if (dimNum < NUM_TWO) {
        return false;
    }
...
NpuArchMatMulRuleBase::PromoteResult Dav2201MatMulRule::GetUpperDtypeByLookUpTable(int inputCase, int8_t cubeMathType)
{
    ...
    static constexpr NpuArchMatMulRuleBase::PromoteResult promoteResultTable[][5] = {
        /* cubeMathType:   KEEP_DTYPE,            ALLOW_FP32_DOWN_P,    USE_FP16,              USE_HF32, USE_FP32_ADD */
        /*0: FP32+FP32*/ {
            {FP32, false, ""}, {FP32, false, ""}, {FP16, false, ""}, {FP32, false, ""}, {FP32, false, ""}},
        /*1: FP32+FP16*/
        {{FP32, false, ""}, {FP32, false, ""}, {FP16, false, ""}, {FP32, false, ""}, {FP32, false, ""}},
        /*2: FP16+FP16*/
        {{FP16, false, ""}, {FP16, false, ""}, {FP16, false, ""}, {FP16, false, WARN0}, {FP16, false, ""}},
        /*3: FP32+BF16*/
        {{FP32, false, ""}, {FP32, false, ""}, {FP16, false, WARN6}, {FP32, false, ""}, {FP32, false, ""}},
        /*4: FP16+BF16*/
