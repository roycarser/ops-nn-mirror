...
#ifndef OP_API_OP_API_COMMON_INC_LEVEL0_OP_TRANSPOSE_QUANT_BATCH_MAT_MUL_OP_H_
#define OP_API_OP_API_COMMON_INC_LEVEL0_OP_TRANSPOSE_QUANT_BATCH_MAT_MUL_OP_H_
