...
/* !
 * \file transpose_quant_batch_mat_mul_simplifiedkey.h
 * \brief
 */

#ifndef __OP_HOST_TRANSPOSE_QUANT_BATCH_MATMUL_SIMPILIFIEDKEY_H__
#define __OP_HOST_TRANSPOSE_QUANT_BATCH_MATMUL_SIMPILIFIEDKEY_H__
...
inline ge::graphStatus GenSimplifiedKey(gert::TilingContext* context, ge::char_t* simplifiedKey)
{
    ...
    static const int32_t X1_SCALE_INDEX = 3;
    static const int32_t X2_SCALE_INDEX = 4;
    ...
    simpleKeyTemp.append(std::to_string(input0Format))
        ...
        .append("/")
        .append(std::to_string(x1ScaleDataType))
        .append("/")
...
#endif // __OP_HOST_TRANSPOSE_QUANT_BATCH_MATMUL_SIMPILIFIEDKEY_H__