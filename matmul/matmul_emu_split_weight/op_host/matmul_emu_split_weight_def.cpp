...
namespace ops {
class MatmulEmuSplitWeight : public OpDef {
public:
    explicit MatmulEmuSplitWeight(const char* name) : OpDef(name)
    {
        this->Input("x").ParamType(REQUIRED).DataType({ge::DT_BF16}).Format({ge::FORMAT_ND});
