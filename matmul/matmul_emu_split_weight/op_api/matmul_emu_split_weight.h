 ...
 */
#ifndef OP_API_INC_LEVEL0_MATMUL_EMU_SPLIT_WEIGHT_H_
#define OP_API_INC_LEVEL0_MATMUL_EMU_SPLIT_WEIGHT_H_
...
#endif // OP_API_INC_LEVEL0_MATMUL_EMU_SPLIT_WEIGHT_H_
