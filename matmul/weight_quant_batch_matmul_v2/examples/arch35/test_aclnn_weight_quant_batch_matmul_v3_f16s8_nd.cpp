...
int AclnnWeightQuantBatchMatmulV3A16W8NdTest(int32_t deviceId, aclrtStream& stream)
{
    ...
    ret = aclnnWeightQuantBatchMatmulV3GetWorkspaceSize(
        x, weight, antiquantScale, nullptr, nullptr, nullptr, nullptr, 0, 0, y, &workspaceSize, &executor);
...
int main()
{
    ...
    int32_t deviceId = 0;
    aclrtStream stream;
    auto ret = AclnnWeightQuantBatchMatmulV3A16W8NdTest(deviceId, stream);
    CHECK_FREE_RET(ret == ACL_SUCCESS, LOG_PRINT("AclnnWeightQuantBatchMatmulV3A16W8NdTest failed. ERROR: %d\n", ret);
                   return ret);
