...
template <PpMatMulNS::ArchType ArchTag, typename ElementA, typename ElementB, typename AccDTypeC, bool IsTransposeA>
struct mmad {
...
template <PpMatMulNS::ArchType ArchTag, typename AccDTypeC, typename ElementA, typename ElementB>
