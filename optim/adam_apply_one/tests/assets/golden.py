...
__golden__ = {
    "kernel": {
        "adam_apply_one": "adam_apply_one_golden"
    }
}


def adam_apply_one_golden(input0, input1, input2, input3, input4, 
                          mul0_x, mul1_x, mul2_x, mul3_x, add2_y,
                          **kwargs):
    '''
    Golden function for adam_apply_one.
    All the parameters (names and order) follow @adam_apply_one_def.cpp without outputs.
