...
若需求被接纳，[sig成员](https://gitcode.com/cann/community/blob/master/CANN/sigs/ops-nn/sig-info.yaml)将为您分配合适的算子分类路径（如：`experimental/activation`），请将贡献算子提交至`experimental`对应算子分类目录。
