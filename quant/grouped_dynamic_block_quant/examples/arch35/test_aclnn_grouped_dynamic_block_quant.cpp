...
int main()
{
    ...
    ret = aclnnGroupedDynamicBlockQuantGetWorkspaceSize(x, groupList, minScale, (char*)roundMode,
                                                        aclDataType::ACL_FLOAT8_E5M2, rowBlockSize, colBlockSize,
                                                        groupListType, y, scale, &workspaceSize, &executor);
