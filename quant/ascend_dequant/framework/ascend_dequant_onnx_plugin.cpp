...
REGISTER_CUSTOM_OP("AscendDequant")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("ai.onnx::8::AscendDequant"), ge::AscendString("ai.onnx::9::AscendDequant"),
                   ge::AscendString("ai.onnx::10::AscendDequant"), ge::AscendString("ai.onnx::11::AscendDequant"),
                   ge::AscendString("ai.onnx::12::AscendDequant"), ge::AscendString("ai.onnx::13::AscendDequant"),
                   ge::AscendString("ai.onnx::14::AscendDequant"), ge::AscendString("ai.onnx::15::AscendDequant"),
                   ge::AscendString("ai.onnx::16::AscendDequant"), ge::AscendString("ai.onnx::17::AscendDequant"),
                   ge::AscendString("ai.onnx::18::AscendDequant"), ge::AscendString("ai.onnx::19::AscendDequant"),
                   ge::AscendString("ai.onnx::20::AscendDequant"), ge::AscendString("ai.onnx::21::AscendDequant"),
