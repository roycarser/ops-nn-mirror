...
/*!
 * \file ascend_anti_quant_v2_per_channel_nddma_no_offset_regbase.h
 * \brief ascend_anti_quant_v2 kernel
 */

#ifndef ASCEND_ANTI_QUANT_V2_PER_CHANNEL_NDDMA_NO_OFFSET_REGBASE_H_
#define ASCEND_ANTI_QUANT_V2_PER_CHANNEL_NDDMA_NO_OFFSET_REGBASE_H_
...
class AscendAntiQuantV2PerChannelNddmaNoOffsetRegbase : public AscendAntiQuantV2Base<T, T1, T2, U, SqrtMode> {
public:
    __aicore__ inline AscendAntiQuantV2PerChannelNddmaNoOffsetRegbase(const AscendAntiQuantV2TilingData* tilingData)
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::Init(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::Process()
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::ParseCoreBlocks(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::CopyInScale(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::CopyXAndCompute(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::CopyInX(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::Compute(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::CopyOutY(
