...
#ifndef ASCEND_ANTI_QUANT_V2_PER_HEAD_NDDMA_NO_OFFSET_REGBASE_H
#define ASCEND_ANTI_QUANT_V2_PER_HEAD_NDDMA_NO_OFFSET_REGBASE_H
...
class AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase : public AscendAntiQuantV2Base<T, T1, T2, U, SqrtMode> {
public:
     __aicore__ inline AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase(const AscendAntiQuantV2TilingData* tilingData)
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::Init(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::Process()
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::ProcessParamOneLoop(int64_t nLoopLen, int64_t baseSOffset, int64_t baseXOffset)
{
    // copy in scale
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::CopyInParam(
    TQue<QuePosition::VECIN, bufferNum>& inQueue, GlobalTensor<T1>& inGm, int64_t paramLen,
    int64_t paramOffset)
{
    ...
    T1 constValue = 0;
    AscendC::MultiCopyParams<T1, AscendAntiQuantV2Base<T, T1, T2, U, SqrtMode>::MULTI_COPY_DIM>
        paramsMain = {multiCopyParams, constValue};
    AscendC::DataCopy<
        T1, AscendAntiQuantV2Base<T, T1, T2, U, SqrtMode>::MULTI_COPY_DIM, copyConfig>(
        paramLocal, inGm[paramOffset], paramsMain);
    inQueue.EnQue(paramLocal);
}

template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::ParseCoreBlocks(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::ProcessInputLoop(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::CopyInX(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::Compute(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::CopyOutY(
...
#endif //ASCEND_ANTI_QUANT_V2_PER_HEAD_NDDMA_NO_OFFSET_REGBASE_H