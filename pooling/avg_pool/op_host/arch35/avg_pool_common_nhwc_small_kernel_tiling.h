...
/*!
 * \file avg_pool_common_nhwc_small_kernel_tiling.h
 * \brief
 */

#ifndef AVG_POOL_COMMON_NHWC_SMALL_KERNEL_TILING_H_
#define AVG_POOL_COMMON_NHWC_SMALL_KERNEL_TILING_H_
...
#endif // AVG_POOL_COMMON_NHWC_SMALL_KERNEL_TILING_H_