...
public:
    ...
    __aicore__ inline void MaxPoolAndArgmaxVF(__ubuf__ T1* xLocal, __ubuf__ T1* maxValueLocal,
                                              __ubuf__ T2* argmaxLocal);
    template <const bool IS_SPLIT_KERNEL>
    __aicore__ inline void MaxPoolAndArgmaxVFForPad(__ubuf__ T1* xLocal, __ubuf__ T1* maxValueLocal,
                                                    __ubuf__ T2* argmaxLocal);
...
template <typename T1, typename T2, uint32_t IS_PAD, uint32_t NANPROP>
__aicore__ inline void MaxPoolWithArgmaxNhwCKernel<T1, T2, IS_PAD, NANPROP>::CopyResultToUb(__ubuf__ T1* maxValueLocal,
                                                                                            __ubuf__ T2* argmaxLocal)
{
    __ubuf__ T1* maxValueHelp = (__ubuf__ T1*)helperTBuf_.Get<T1>().GetPhyAddr();
    __ubuf__ T2* argmaxHelp = (__ubuf__ T2*)helperTBuf_.Get<T2>().GetPhyAddr() + HELPER_BUFFER_SIZE_512 / sizeof(T1);
...
template <typename T1, typename T2, uint32_t IS_PAD, uint32_t NANPROP>
__aicore__ inline void MaxPoolWithArgmaxNhwCKernel<T1, T2, IS_PAD, NANPROP>::Compute(__ubuf__ T1* maxValueLocal,
                                                                                     __ubuf__ T2* argmaxLocal)
{
...
template <typename T1, typename T2, uint32_t IS_PAD, uint32_t NANPROP>
__aicore__ inline void MaxPoolWithArgmaxNhwCKernel<T1, T2, IS_PAD, NANPROP>::FillPadNegVF(__ubuf__ T1* xLocalAddr)
{
