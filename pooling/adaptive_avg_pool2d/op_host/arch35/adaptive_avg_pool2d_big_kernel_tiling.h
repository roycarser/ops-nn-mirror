...
/*!
 * \file adaptive_avg_pool2d_big_kernel_tiling.h
 * \brief
 */

#ifndef AIR_CXX_RUNTIME_V2_OP_IMPL_ADAPTIVE_AVG_POOL2D_TILING_BIG_KERNEL_H_
#define AIR_CXX_RUNTIME_V2_OP_IMPL_ADAPTIVE_AVG_POOL2D_TILING_BIG_KERNEL_H_
...
public:
    explicit AdaptiveAvgPool2dBigKernelTiling(gert::TilingContext* context) : AdaptivePool2dBaseTiling(context) {}
