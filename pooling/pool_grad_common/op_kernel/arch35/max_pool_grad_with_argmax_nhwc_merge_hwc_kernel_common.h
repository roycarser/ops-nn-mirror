...
/*!
 * \file max_pool_grad_with_argmax_nhwc_merge_hwc_kernel_common.h
 * \brief
 */

#ifndef MAX_POOL_GRAD_WITH_ARGMAX_NHWC_MERGE_HWC_KERNEL_COMMON_H_
#define MAX_POOL_GRAD_WITH_ARGMAX_NHWC_MERGE_HWC_KERNEL_COMMON_H_
...
class MaxPoolGradWithArgmaxKernelNHWCMergeHWCBase : public MaxPoolGradWithArgmaxKernelNHWCBase<T1, T2, int32_t, IS_CHECK_RANGE, VER>
{
public:
