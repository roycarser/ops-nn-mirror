                                                                       ...
                                                                       uint32_t ubFactor)
{
    __VEC_SCOPE__
    {
        ...
        AscendC::MicroAPI::RegTensor<float> sumReg, lnReg, maxReg, vreg1, vreg2, vreg3;
        AscendC::MicroAPI::RegTensor<Ty> vreg4;
        AscendC::MicroAPI::MaskReg mask;
        AscendC::MicroAPI::MaskReg maskAll = MicroAPI::CreateMask<float, AscendC::MicroAPI::MaskPattern::ALL>();
        ...
        AscendC::MicroAPI::Ln(lnReg, sumReg, maskAll);
        ...
        for (uint16_t j = 0; j < repeatTimes; j++) {
            ...
            AscendC::MicroAPI::Sub(vreg3, vreg2, lnReg, mask);
