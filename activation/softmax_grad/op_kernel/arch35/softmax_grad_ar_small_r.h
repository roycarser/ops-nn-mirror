...
private:
        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t k = 0; k < loopA0Num; k++) {
                ...
                for (uint16_t i = 0; i < curTileRLenVl; i++) {
                    ...
                    StoreAlign(tmpAddr2 + xOffset, x0Reg, pregMask);
                }
            }
        }
    ...
    __aicore__ inline void CalcOutput(const __ubuf__ T* x0Local, uint32_t curTileA0Len)
    {
        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t k = 0; k < loopA0Num; k++) {
                ...
                for (uint16_t i = 0; i < curTileRLenVl; i++) {
                    ...
                    LoadAlign(x1Reg, tmpAddr2 + xOffset);
