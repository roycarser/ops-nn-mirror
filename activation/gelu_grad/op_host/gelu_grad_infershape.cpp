...
static ge::graphStatus InferShapeForGeluGrad(gert::InferShapeContext* context)
{
    OP_LOGD(context->GetNodeName(), "Begin to do GeluGradInferShape");
...
IMPL_OP_INFERSHAPE(GeluGrad).InferShape(InferShapeForGeluGrad);
} // namespace ops
