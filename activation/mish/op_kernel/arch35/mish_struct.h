...
#ifndef OPS_NN_ACTIVATION_MISH_KERNEL_STRUCT_H
#define OPS_NN_ACTIVATION_MISH_KERNEL_STRUCT_H
...
ASCENDC_TPL_ARGS_DECL(
    Mish, ASCENDC_TPL_UINT_DECL(schMode, 1, ASCENDC_TPL_UI_LIST, TPL_SCH_MODE_0, TPL_SCH_MODE_1),
...
#endif // OPS_NN_ACTIVATION_MISH_KERNEL_STRUCT_H