...
/*!
 * \file hard_swish_grad_tiling_key.h
 * \brief HardSwishGrad tiling key definition
 *
 * Template parameters:
...
#ifndef __HARD_SWISH_GRAD_TILING_KEY_H__
#define __HARD_SWISH_GRAD_TILING_KEY_H__

#include "ascendc/host_api/tiling/template_argument.h"

ASCENDC_TPL_ARGS_DECL(HardSwishGrad,
