...
private:
    __aicore__ inline void VfSubExp(int64_t tileNum, int64_t r, int64_t rAlign, LocalTensor<float> maxBuf,
                                    LocalTensor<T> featuresBuf, LocalTensor<float> subBuf, LocalTensor<float> temp1Buf);
    __aicore__ inline void VfBackProp(int64_t tileNum, int64_t r, int64_t rAlign, LocalTensor<float> sumBuf,
                                      LocalTensor<float> temp1Buf, LocalTensor<float> logBuf, LocalTensor<T> labelsBuf,
                                      LocalTensor<T> backPropBuf, LocalTensor<float> temp2Buf,
                                      LocalTensor<float> subBuf);
    __aicore__ inline void ProcessEachCore(int64_t tileNum, int64_t tailNum, int64_t loopTimes);
    __aicore__ inline void CopyInPad(TQue<QuePosition::VECIN, 1>& dstQueue, GlobalTensor<T>& srcTensor, int64_t tileNum,
                                     int64_t offset);
    __aicore__ inline void CopyOutPadBackProp(GlobalTensor<T>& dstTensor, TQue<QuePosition::VECOUT, 1>& srcQueue,
                                              int64_t tileNum, int64_t offset, int64_t rNum);
    __aicore__ inline void CopyOutPadLoss(GlobalTensor<T>& dstTensor, TQue<QuePosition::VECOUT, 1>& srcQueue,
                                          int64_t nTailNum, int64_t offset);
    __aicore__ inline void Compute(int64_t tileNum, int64_t aOffset);
    __aicore__ inline void CopyInNDDMA(TQue<QuePosition::VECIN, 1>& dstQueue, GlobalTensor<T>& srcTensor,
                                       int64_t tileNum, int64_t aOffset, int64_t brcDim, uint64_t brcNum);
    __aicore__ inline void VfReduceMax(int64_t tileNum, int64_t r, int64_t rAlign, LocalTensor<float> maxBuf,
                                       LocalTensor<T> featuresBuf);
...
template <typename T, uint64_t schId, uint64_t featuresBrc, uint64_t labelsBrc, uint64_t db>
__aicore__ inline void SoftmaxCrossEntropyWithLogitsFullLoad<T, schId, featuresBrc, labelsBrc, db>::Init(
...
template <typename T, uint64_t schId, uint64_t featuresBrc, uint64_t labelsBrc, uint64_t db>
__aicore__ inline void SoftmaxCrossEntropyWithLogitsFullLoad<T, schId, featuresBrc, labelsBrc, db>::ProcessEachCore(
...
template <typename T, uint64_t schId, uint64_t featuresBrc, uint64_t labelsBrc, uint64_t db>
__aicore__ inline void SoftmaxCrossEntropyWithLogitsFullLoad<T, schId, featuresBrc, labelsBrc, db>::Compute(
    int64_t tileNum, int64_t aOffset)
{
...
template <typename T, uint64_t schId, uint64_t featuresBrc, uint64_t labelsBrc, uint64_t db>
__aicore__ inline void SoftmaxCrossEntropyWithLogitsFullLoad<T, schId, featuresBrc, labelsBrc, db>::CopyInPad(
    TQue<QuePosition::VECIN, 1>& dstQueue, GlobalTensor<T>& srcTensor, int64_t tileNum, int64_t offset)
{
...
template <typename T, uint64_t schId, uint64_t featuresBrc, uint64_t labelsBrc, uint64_t db>
__aicore__ inline void SoftmaxCrossEntropyWithLogitsFullLoad<T, schId, featuresBrc, labelsBrc, db>::CopyInNDDMA(
    TQue<QuePosition::VECIN, 1>& dstQueue, GlobalTensor<T>& srcTensor, int64_t tileNum, int64_t aOffset, int64_t brcDim,
    uint64_t brcNum)
{
    int64_t rNumAlign = rUbNumFactor_;
    LocalTensor<T> dstBuf = dstQueue.AllocTensor<T>();
...
template <typename T, uint64_t schId, uint64_t featuresBrc, uint64_t labelsBrc, uint64_t db>
__aicore__ inline void SoftmaxCrossEntropyWithLogitsFullLoad<T, schId, featuresBrc, labelsBrc, db>::CopyOutPadBackProp(
    GlobalTensor<T>& dstTensor, TQue<QuePosition::VECOUT, 1>& srcQueue, int64_t tileNum, int64_t offset, int64_t rNum)
{
...
template <typename T, uint64_t schId, uint64_t featuresBrc, uint64_t labelsBrc, uint64_t db>
__aicore__ inline void SoftmaxCrossEntropyWithLogitsFullLoad<T, schId, featuresBrc, labelsBrc, db>::CopyOutPadLoss(
    GlobalTensor<T>& dstTensor, TQue<QuePosition::VECOUT, 1>& srcQueue, int64_t nTailNum, int64_t offset)
{
    LocalTensor<T> srcBuf = srcQueue.DeQue<T>();
    DataCopyExtParams copyParams;
...
template <typename T, uint64_t schId, uint64_t featuresBrc, uint64_t labelsBrc, uint64_t db>
__aicore__ inline void SoftmaxCrossEntropyWithLogitsFullLoad<T, schId, featuresBrc, labelsBrc, db>::VfReduceMax(
    int64_t tileNum, int64_t r, int64_t rAlign, LocalTensor<float> maxBuf, LocalTensor<T> featuresBuf)
{
...
template <typename T, uint64_t schId, uint64_t featuresBrc, uint64_t labelsBrc, uint64_t db>
__aicore__ inline void SoftmaxCrossEntropyWithLogitsFullLoad<T, schId, featuresBrc, labelsBrc, db>::VfSubExp(
    int64_t tileNum, int64_t r, int64_t rAlign, LocalTensor<float> maxBuf, LocalTensor<T> featuresBuf,
...
template <typename T, uint64_t schId, uint64_t featuresBrc, uint64_t labelsBrc, uint64_t db>
__aicore__ inline void SoftmaxCrossEntropyWithLogitsFullLoad<T, schId, featuresBrc, labelsBrc, db>::VfBackProp(
    int64_t tileNum, int64_t r, int64_t rAlign, LocalTensor<float> sumBuf, LocalTensor<float> temp1Buf,
    LocalTensor<float> logBuf, LocalTensor<T> labelsBuf, LocalTensor<T> backPropBuf, LocalTensor<float> temp2Buf,
    LocalTensor<float> subBuf)
{
