...
if(gtest_FOUND AND NOT FORCE_REBUILD_CANN_3RD)
    ...
    message(STATUS "[ThirdPartyLib][gtest] gtest shared not found, finding binary file.")
    if(EXISTS "${CANN_3RD_LIB_PATH}/pkg/googletest-1.14.0.tar.gz")
        set(REQ_URL "file://${CANN_3RD_LIB_PATH}/pkg/googletest-1.14.0.tar.gz")
        message(STATUS "[ThirdPartyLib][gtest] found in ${REQ_URL}.")
    elseif(EXISTS "${CANN_3RD_LIB_PATH}/googletest-1.14.0.tar.gz")
        set(REQ_URL "file://${CANN_3RD_LIB_PATH}/googletest-1.14.0.tar.gz")
        message(STATUS "[ThirdPartyLib][gtest] found in ${REQ_URL}.")
    else()
