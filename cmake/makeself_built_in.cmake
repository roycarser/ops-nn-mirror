...
configure_file(
    ${NN_VERSION_OUT_PUT}
    ${STAGING_DIR}/${CMAKE_SYSTEM_PROCESSOR}-linux/include/version/ops_nn_version.h
    COPYONLY
)
...
if(EXISTS "${STAGING_DIR}/${CMAKE_SYSTEM_PROCESSOR}-linux/include/version/ops_nn_version.h")
    execute_process(COMMAND chmod 440 "${STAGING_DIR}/${CMAKE_SYSTEM_PROCESSOR}-linux/include/version/ops_nn_version.h")
endif()
