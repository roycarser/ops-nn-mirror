...
每个算子分为[两段式接口](../../../docs/zh/context/two_phase_api.md)，必须先调用“aclnnBatchNormReduceGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnBatchNormReduce”接口执行计算。
...
- **参数说明**
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      ...
      <td>输出</td>
      <td>表示求平方和的输出Tensor，对应公式中的`squareSum`。</td>
      <td><ul><li>支持空Tensor。</li><li>shape需要与输入`x`的第二维的值一致。</li></ul></td>
      <td>FLOAT32</td>
      <td>ND</td>
      <td>1</td>
