...
int main()
{
    ...
    ret = CreateAclTensor(zeroPoints1HostData, gammaShape, &zeroPoints1DeviceAddr, aclDataType::ACL_INT32,
                          &zeroPoints1);
    CHECK_RET(ret == ACL_SUCCESS, return ret);
    // 创建y1 aclTensor
    ...
    ret = aclnnAddRmsNormQuantV2GetWorkspaceSize(x1, x2, gamma, scales1, nullptr, zeroPoints1, nullptr, beta, axis,
                                                 epsilon, divMode, y1, y2, x, nullptr, &workspaceSize, &executor);
