...
/*!
 * \file rms_norm_grad_quant_dgamma_helper.h
 * \brief RmsNormGrad regbase dgamma helper file
 */
#ifndef RMS_NORM_GRAD_DGAMMA_QUANT_HELPER_H
#define RMS_NORM_GRAD_DGAMMA_QUANT_HELPER_H
...
template <typename DY_TYPE, typename X_TYPE, typename RSTD_TYPE>
