...
/* !
 * \file rms_norm_grad_quant_dgamma_big_m.h
 * \brief
 */

#ifndef RMS_NORM_GRAD_QUANT_DGAMMA_BIG_M_
#define RMS_NORM_GRAD_QUANT_DGAMMA_BIG_M_
...
private:
    const RmsNormGradQuantRegbaseBigMTilingData* td_;
    TPipe* pipe_;
...
}; // RmsNormGradQuantDgammaBigM

} // namespace RmsNormGradQuant
#endif // RMS_NORM_GRAD_QUANT_DGAMMA_BIG_M_
