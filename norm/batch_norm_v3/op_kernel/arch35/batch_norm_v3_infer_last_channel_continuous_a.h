...
/* !
 * \file batch_norm_v3_infer_last_channel_continuous_a.h
 * \brief
 */

#ifndef BATCH_NORM_V3_INFER_LAST_CHANNEL_CONTINUOUS_A_H
#define BATCH_NORM_V3_INFER_LAST_CHANNEL_CONTINUOUS_A_H
...
public:
    ...
    __aicore__ inline BatchNormV3InferLastChannelContinuousA(const BatchNormV3InferLastChannelTilingData* tilingDataIn)
    {
...
private:
                                               ...
                                               __ubuf__ float* meanFp32Local, __ubuf__ float* rstdFp32Local)
    {
        __VEC_SCOPE__
        {
            ...
            uint16_t aLoopNum = CeilDiv(static_cast<uint16_t>(totalALen), VL_FP32);
