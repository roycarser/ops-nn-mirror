...
/*!
 * \file group_norm_v2_regbase_two_pass_generalized.h
 * \brief
 */

#ifndef GROUP_NORM_V2_REGBASE_TWO_PASS_GENERALIZED_H_
#define GROUP_NORM_V2_REGBASE_TWO_PASS_GENERALIZED_H_
...
class GroupNormV2TwoPassGeneralized {
public:
    __aicore__ inline GroupNormV2TwoPassGeneralized(){};
...
private:
                                             ...
                                             uint32_t numPerCoreLoop)
    {
        ...
        for (int64_t i = 0; i < numPerCoreProcess; i++) {
            ...
            __ubuf__ T1* yOutLocal = (__ubuf__ T1*)yTensor[outputUbOffset + i * elemNumAlign].GetPhyAddr();
