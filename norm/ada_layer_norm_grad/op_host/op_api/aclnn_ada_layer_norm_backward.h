...
#ifndef OP_API_INC_LEVEL2_ADA_LAYER_NORM_BACKWARD_H_
#define OP_API_INC_LEVEL2_ADA_LAYER_NORM_BACKWARD_H_
...
/**
 * @brief aclnnAdaLayerNormBackward的第一段接口，根据具体的计算流程，计算workspace大小。
...
#endif // OP_API_INC_LEVEL2_ADA_LAYER_NORM_BACKWARD_H_