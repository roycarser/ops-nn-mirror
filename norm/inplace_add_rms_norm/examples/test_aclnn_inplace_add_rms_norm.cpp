...
int main()
{
    ...
    ret = aclrtMemcpy(resultData.data(), resultData.size() * sizeof(resultData[0]), x1RefDeviceAddr,
    ...
    ret = aclrtMemcpy(resultData1.data(), resultData1.size() * sizeof(resultData1[0]), x2RefDeviceAddr,
