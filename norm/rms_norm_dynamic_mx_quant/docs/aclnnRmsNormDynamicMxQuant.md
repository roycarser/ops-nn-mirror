...
每个算子分为[两段式接口](../../../docs/zh/context/两段式接口.md)，必须先调用`aclnnRmsNormDynamicMxQuantGetWorkspaceSize`接口获取入参并根据计算流程所需workspace大小，再调用`aclnnRmsNormDynamicMxQuant`接口执行计算。
...
- **参数说明**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      ...
      <td><ul><li>不支持空Tensor。</li><li>shape只能为一维，需要与`x`最后一维维度匹配。</li></ul></td>
    ...
    <tr>
      ...
      <td><ul><li>不支持空Tensor。</li><li>可选参数，支持传入空指针。</li><li>如果提供，shape和数据类型需要与`gamma`保持一致。</li></ul></td>
      <td>FLOAT16、BFLOAT16、FLOAT32</td>
      <td>ND</td>
      <td>1</td>
      <td>√</td>
