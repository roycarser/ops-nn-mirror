...
/*!
 * \file test_layer_norm_tiling.cpp
 * \brief
 */
...
#include "../../../../op_host/arch35/layer_norm_tiling_arch35.h"
...
TEST_F(LayerNormTilingTest, layer_norm_tiling_regbase_two_pass)
{
    ...
    gert::StorageShape var_shape = {{64}, {64}};
    float eps = 1e-5;
    ...
    platform_info.Init();
    // compile info
    optiling::LayerNormOpInfo compile_info;
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .OutputShapes({&y_shape, &mean_shape, &var_shape})
