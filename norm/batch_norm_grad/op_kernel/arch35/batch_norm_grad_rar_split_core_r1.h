...
/* !
 * \file batch_norm_grad_rar_split_core_r1.h
 * \brief
 */

#ifndef __BATCH_NORM_GRAD_SPLIT_CORE_R1_H__
#define __BATCH_NORM_GRAD_SPLIT_CORE_R1_H__
...
private:
    const BatchNormGradRARSplitCoreR1TilingData* tilingData_{nullptr};
    TPipe* pipe_{nullptr};
