...
/* !
 * \file batch_norm_grad_ra_split_r_regbase.h
 * \brief
 */

#ifndef __BATCH_NORM_GRAD_RA_SPLIT_R_REGBASE_H__
#define __BATCH_NORM_GRAD_RA_SPLIT_R_REGBASE_H__
...
private:
                                   ...
                                   const LocalTensor<WEIGHT_TYPE>& gammaTensor)
    {
        ...
        __VEC_SCOPE__
        {
            ...
            __ubuf__ DY_TYPE* dxAddr = (__ubuf__ DY_TYPE*)dxTensor.GetPhyAddr();
...
private:
    const BatchNormGradRASplitRTilingData* tilingData_{nullptr};
    TPipe* pipe_{nullptr};
