...
- 接口功能：将tensor中的每个元素根据dim这个维度，每个元素重复repeats的相应次数。
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>outputSize值必须为repeats * self的dim维度size。</td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
      ...
      <tr>
        ...
        <td>数据类型需要与self一致。<br>shape维度数量与self一致，out的shape在dim维度下的size等于repeats * self在dim维度下的size。</td>
        <td>UINT8、INT8、INT16、INT32、INT64、BOOL、FLOAT16、BFLOAT16、FLOAT</td>
        <td>ND</td>
        <td>1-8</td>
        <td>√</td>
  ...
  <table style="undefined;table-layout: fixed; width: 1100px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
        <td>workspaceSize</td>
        <td>输入</td>
        <td>在Device侧申请的workspace大小，由第一段接口aclnnRepeatInterleaveIntWithDimGetWorkspaceSize获取。</td>
      </tr>
      <tr>
        <td>executor</td>
        <td>输入</td>
...
- 其他限制：在计算时需要满足要求：outputSize = self的dim维度的size * repeats的值。
