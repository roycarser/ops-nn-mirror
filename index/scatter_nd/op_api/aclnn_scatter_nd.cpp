/**
 * Copyright (c) 2025-2006 Huawei Technologies Co., Ltd.
...
#include "../../scatter_nd_update/op_api/scatter_nd_update.h"
...
static bool CheckShape(const aclTensor* data, const aclTensor* indices, const aclTensor* updates, const aclTensor* out)
{
    ...
    OP_CHECK_MAX_DIM(data, MAX_INPUT_DIM_NUM, return false);
    OP_CHECK_MAX_DIM(indices, MAX_INPUT_DIM_NUM, return false);
    OP_CHECK_MAX_DIM(updates, MAX_INPUT_DIM_NUM, return false);
