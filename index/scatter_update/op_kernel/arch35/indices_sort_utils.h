 ...
 */
#ifndef ASCENDC_SCATTER_UPDATE_INDICES_SORT_UTILS_H_
#define ASCENDC_SCATTER_UPDATE_INDICES_SORT_UTILS_H_

#include "op_kernel/math_util.h"

namespace ScatterUpdate {
using namespace AscendC;
constexpr uint64_t LAST_DIM_SIZE_LIMIT = 512;
constexpr uint64_t INDICES_BUCKETS_SIZE = 256;
constexpr uint32_t FNV_PRIME_B32 = 0x01000193;
constexpr uint64_t FNV_PRIME_B64 = 0x0100000001B3;
constexpr uint32_t FNV_OFFSET_BIASIS_B32 = 0x811C9DC5;
constexpr uint64_t FNV_OFFSET_BIASIS_B64 = 0xCBF29CE484222325;
