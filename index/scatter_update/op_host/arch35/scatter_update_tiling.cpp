...
/*!
 * \file scatter_update_tiling.cpp
 * \brief
 */
...
ge::graphStatus TilingPrepareScatterUpdateForAscendC(gert::TilingParseContext* context)
{
    OP_LOGD(context->GetNodeName(), "Start init ScatterUpdate Tiling.");
    auto compile_info = context->GetCompiledInfo<ScatterUpdateCompileInfo>();
