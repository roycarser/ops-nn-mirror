...
#ifndef SPARSE_SEGMENT_MEAN_SIMT_LOOP_H
#define SPARSE_SEGMENT_MEAN_SIMT_LOOP_H
...
__aicore__ inline void SparseSegmentMeanSimtLoop<X_T, INDICES_T, SEGMENTIDS_T>::Process()
{
    ...
    AscendC::Simt::VF_CALL<SimtLoopComputer<X_T, INDICES_T>>(Simt::Dim3{threadNumX, threadNumY}, segOffsetBase_, curCoreSegments_, innerSize, xDim0,
