...
/*!
 * \file reverse_sequence_bas_tiling.h
 * \brief
 */

#ifndef REVERSE_SEQUENCE_BAS_TILING_H_
#define REVERSE_SEQUENCE_BAS_TILING_H_
...
private:
    ...
    void DoBlockTiling();
    int64_t CalcBufferSize(int64_t inDimB, int64_t inDimS, int64_t inDimA);
    void CalcSplitDimA();
    void CalcSplitDimS();
    void CalcSplitDimB();
    ...
    int64_t inUbSize_{0};
    int64_t seqUbByte_{0};
    int64_t threadNumX_{1024};
...
#endif // REVERSE_SEQUENCE_BAS_TILING_H_
