...
/*!
 * \file test_embedding_tiling.cpp
 * \brief
 */
#include <iostream>
#include <vector>
...
#include "../../../../op_host/arch35/embedding_tiling_simt.h"
#include "../../../../op_host/arch35/embedding_no_contiguous_tiling.h"
#include "log/log.h"
...
TEST_F(EmbeddingTiling, embedding_simt_tiling_1)
{
    ...
    ASSERT_EQ(tiling_key, 2000000008);

    auto tiling_data_result = TilingData2Str(tiling_context->GetRawTilingData());
    std::cout << tiling_data_result << std::endl;
}

TEST_F(EmbeddingTiling, embedding_simt_tiling_2)
{
    gert::StorageShape params_shape = {{2, 18}, {2, 18}};
    gert::StorageShape indices_shape = {{130}, {130}};
    gert::StorageShape y_shape = {{130, 8}, {130, 8}};
    ge::DataType params_dtype = ge::DT_INT8;
    ge::DataType indices_dtype = ge::DT_INT64;
    ...
    // todo check tiling result
    auto tiling_key = tiling_context->GetTilingKey();
    ASSERT_EQ(tiling_key, 2000000002);

    auto tiling_data_result = TilingData2Str(tiling_context->GetRawTilingData());
    std::cout << tiling_data_result << std::endl;
}

TEST_F(EmbeddingTiling, embedding_simt_tiling_3)
{
    gert::StorageShape params_shape = {{11, 69}, {11, 69}};
    gert::StorageShape indices_shape = {{800}, {800}};
    gert::StorageShape y_shape = {{800, 69}, {800, 69}};
    ge::DataType params_dtype = ge::DT_FLOAT;
    ge::DataType indices_dtype = ge::DT_INT32;
...
TEST_F(EmbeddingTiling, embedding_simt_tiling_4)
{
    gert::StorageShape params_shape = {{12, 69}, {12, 69}};
    gert::StorageShape indices_shape = {{780}, {780}};
    gert::StorageShape y_shape = {{780, 69}, {780, 69}};
    ge::DataType params_dtype = ge::DT_INT8;
    ge::DataType indices_dtype = ge::DT_INT32;
    ...
    // todo check tiling result
    auto tiling_key = tiling_context->GetTilingKey();
    ASSERT_EQ(tiling_key, 2000000001);
