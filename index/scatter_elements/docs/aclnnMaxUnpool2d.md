...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">
        <ul>
          <li>数据类型与out的数据类型一致。</li>
          <li>shape与indices保持一致。</li>
          <li>当维度为3时，各维度依次表示C、H、W，当维度为4时，各维度依次表示N、C、H、W，其中C代表channel, N代表Batch，H代表Height，W代表Width。</li>
        </ul>
      </td>
...
- **返回值：**
  ...
  <tbody>
    <tr>
      ...
      <td>161001</td>
      <td>传入的self、indices、outputSize或out是空指针。</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>outputSize的两个元素乘积值小于self在H和W维度上的size乘积值。</td>
    </tr>
    <tr>
      <td>out在N、C维度上的size大小与self未完全相同。</td>
    </tr>
    <tr>
      <td>out在H、W维度上的size大小与outputSize中的两个元素值不相等。</td>
    </tr>
    <tr>
      <td>outputSize的乘积小于self的H轴与W轴的乘积。 </td>
    </tr>
  </tbody>
  </table>
