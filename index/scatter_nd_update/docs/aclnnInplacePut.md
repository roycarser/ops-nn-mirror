...
[📄 查看源码](https://gitcode.com/cann/ops-nn/tree/master/index/scatter_nd_update)
...
- 接口功能：将selfRef视为一维张量，把index张量中元素值作为索引，如果accumulate为true，把source中元素和selfRef对应的位置上元素做累加操作；如果accumulate为false，把source中元素替换掉selfRef对应位置上的元素。
- 计算公式：
...
- **参数说明**
    ...
    - <term>Atlas 训练系列产品</term>、<term>Atlas 推理系列产品</term>：数据类型不支持BFLOAT16、COMPLEX64、COMPLEX128。
...
- **返回值**
  ...
  <table style="undefined;table-layout: fixed; width: 1244px"><colgroup>
    ...
    <tbody>
      ...
      <td>161001</td>
      <td>传入的selfRef、index、source是空指针。</td>
      </tr>
      <tr>
      ...
      <tr>
      <td>source和index的元素数量不等。</td>
      </tr>
      <tr>
      <td>selfRef是空tensor，index不是空tensor。</td>
      </tr>
    </tbody>
    </table>
...
- **参数说明**
  <table style="undefined;table-layout: fixed; width: 1244px"><colgroup>
      ...
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnInplacePutGetWorkspaceSize获取。</td>
      </tr>
      <tr>
      <td>executor</td>
      <td>输入</td>
