...
int main()
{
    ...
    std::vector<float> varRefHostData = {
        0.3816, 0.3939, 0.8474, 0.1652, 0.6049, 0.3315, 0.4954, 0.3284, 0.7060, 0.4359, 0.6514, 0.9476, 0.4708, 0.0656,
        0.9652, 0.9512, 0.6452, 0.1981, 0.4159, 0.9575, 0.1516, 0.4987, 0.9107, 0.6635, 0.4119, 0.4845, 0.5558, 0.2749,
        0.6230, 0.1180, 0.2400, 0.9971, 0.4093, 0.5561, 0.4023, 0.6612, 0.4109, 0.8470, 0.9733, 0.6947, 0.7980, 0.7957};
    std::vector<int64_t> indicesHostData = {1, 0, 0, 2};
