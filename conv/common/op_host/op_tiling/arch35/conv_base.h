...
static std::map<ge::DataType, std::string> dtypeToStrTab = {{ge::DataType::DT_FLOAT, "float32"},
                                                            {ge::DataType::DT_FLOAT16, "float16"},
                                                            {ge::DataType::DT_BF16, "bfloat16"},
                                                            {ge::DataType::DT_INT64, "int64"},
                                                            {ge::DataType::DT_UINT64, "uint64"},
                                                            {ge::DataType::DT_INT32, "int32"},
                                                            {ge::DataType::DT_INT8, "int8"},
                                                            {ge::DataType::DT_HIFLOAT8, "hifloat8"},
...
static std::map<ge::Format, std::string> formatToStrTab = {{ge::FORMAT_NCHW, "NCHW"},
                                                           {ge::FORMAT_NHWC, "NHWC"},
                                                           {ge::FORMAT_HWCN, "HWCN"},
...
static std::map<ge::Format, ConvFormat> formatMap = {{ge::FORMAT_ND, ConvFormat::ND},
                                                     {ge::FORMAT_NCHW, ConvFormat::NCHW},
                                                     {ge::FORMAT_NHWC, ConvFormat::NHWC},
                                                     {ge::FORMAT_HWCN, ConvFormat::HWCN},
                                                     {ge::FORMAT_DHWNC, ConvFormat::DHWNC},
                                                     {ge::FORMAT_DHWCN, ConvFormat::DHWCN},
                                                     {ge::FORMAT_NDHWC, ConvFormat::NDHWC},
                                                     {ge::FORMAT_NCDHW, ConvFormat::NCDHW},
                                                     {ge::FORMAT_NC1HWC0, ConvFormat::NC1HWC0},
                                                     {ge::FORMAT_FRACTAL_Z_C04, ConvFormat::FRACTAL_Z_C04},
...
struct ShapeBound {
    ...
    uint64_t GetUpperBound(ge::DataType dType) const { return boundTab.at(dType); }
};
...
const std::vector<std::string> PADMODE_WHITELIST = {"SPECIFIC", "SAME", "VALID", "SAME_UPPER", "SAME_LOWER"};
...
public:
    ...
    void InitGroupInfo(ConvOriGroupInfo convOriGroupInfo, ConvOptGroupInfo convOptGroupInfo);
    ...
    void GetSupportedFormats(bool quantFlag, bool is2dFlag, std::stringstream& ss,
