...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(BatchOne, ASCENDC_TPL_1_BW, ASCENDC_TPL_UI_LIST, CONV_MULTI_BATCH, CONV_ONE_BATCH),
    ASCENDC_TPL_UINT_DECL(NoPad, ASCENDC_TPL_1_BW, ASCENDC_TPL_UI_LIST, CONV_HAS_PAD, CONV_NO_PAD),
    ASCENDC_TPL_UINT_DECL(SmallWeight, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, CONV_NOT_SMALL_WEIGHT,
                          CONV_FULLLOAD_KL1_NL0, CONV_WEIGHT_SMALLER_THAN_BL0),
    ASCENDC_TPL_UINT_DECL(SmallKernel, ASCENDC_TPL_1_BW, ASCENDC_TPL_UI_LIST, CONV_NOT_SMALL_KERNEL,
                          CONV_SMALL_KERNEL));
...
#define CONV2D_OPT_GROUP_SIMPLIFIED_SEL()                                                                             \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2),                                                             \
        ...
        ASCENDC_TPL_UINT_SEL(L1PingPong, ASCENDC_TPL_UI_LIST, CONV_L1_PINGPONG_ALL_OPEN, CONV_L1_PINGPONG_ALL_CLOSE), \
        ASCENDC_TPL_UINT_SEL(L0PingPong, ASCENDC_TPL_UI_LIST, CONV_L0_PINGPONG_ALL_CLOSE, CONV_L0_PINGPONG_AL0_OPEN,  \
                             CONV_L0_PINGPONG_BL0_OPEN, CONV_L0_PINGPONG_ALL_OPEN),                                   \
        ASCENDC_TPL_UINT_SEL(OutputOrder, ASCENDC_TPL_UI_LIST, CONV_OUTPUT_ORDER_M_MODE),                             \
        ASCENDC_TPL_UINT_SEL(IterOrder, ASCENDC_TPL_UI_LIST, CONV_ITER_ORDER_MITER_FIRST,                             \
                             CONV_ITER_ORDER_NITER_FIRST),                                                            \
        ASCENDC_TPL_UINT_SEL(GroupType, ASCENDC_TPL_UI_LIST, CONV_GROUP_TYPE_OPT_SIMPLIFIED_GROUP_CONV),              \
        ASCENDC_TPL_UINT_SEL(EnableSmallChannel, ASCENDC_TPL_UI_LIST, CONV_ENABLE_SMALL_CHANNEL_CLOSE),               \
        ASCENDC_TPL_UINT_SEL(WeightUbTrans, ASCENDC_TPL_UI_LIST, CONV_WEIGHT_UB_TRANS_CLOSE),                         \
        ASCENDC_TPL_UINT_SEL(FmapCopyMode, ASCENDC_TPL_UI_LIST, CONV_FMAP_LOAD3D_MODE),                               \
        ASCENDC_TPL_UINT_SEL(InnerBatch, ASCENDC_TPL_UI_LIST, CONV_INNER_BATCH_SINGLE),                               \
...
#define CONV2D_WEIGHT_UB_ONLY_AL1_FULLLOAD_SEL()                                                                     \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2),                                                            \
        ...
        CONV2D_COMMON_WEIGHT_UB_SEL() CONV2D_SCALAR_OPT_SEL(CONV_NOT_SMALL_WEIGHT)
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(CONV2D_SMALL_KERNEL_NCHW_SEL()), ASCENDC_TPL_ARGS_SEL(CONV2D_ONLY_MN_FULLLOAD_MIXCORE_SEL()),
    ...
    ASCENDC_TPL_ARGS_SEL(CONV2D_ABL1_FULLLOAD_DB_OPEN_SEL()), ASCENDC_TPL_ARGS_SEL(CONV2D_OPT_GROUP_SIMPLIFIED_SEL()),
    ASCENDC_TPL_ARGS_SEL(CONV2D_OPT_GROUP_SEL()), ASCENDC_TPL_ARGS_SEL(CONV2D_ORI_GROUP_SEL()),
    ASCENDC_TPL_ARGS_SEL(CONV2D_OPT_GROUP_PRELOAD_SEL()), ASCENDC_TPL_ARGS_SEL(CONV2D_WEIGHT_UB_ONLY_MN_FULLLOAD_SEL()),
