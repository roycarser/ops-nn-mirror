...
#if __CCE_AICORE__ == 310
template <uint32_t conv3DDWTemplateId, bool isSplitKernelHW, bool groupEnlarge, uint32_t winogradTilingFlag,bool winogradResidentFlag>
...
{
#if defined(__NPU_ARCH__) && (__NPU_ARCH__ == 3510)
    conv3d_backprop_filter_v2_arch35<conv3DDWTemplateId, isSplitKernelHW, groupEnlarge, winogradTilingFlag, winogradResidentFlag>(
        x, filter_size, out_backprop, y, workSpace, tiling);
    return;
#endif
}
#else
